...
???+ "🔢 Contrôle des versions des packages majeurs"
    ...
    ✅ pyodide-mkdocs-theme : 5.1.1

    ⚠️ pymox-kit : installé 1.0.3, dernière version 1.0.10

!!! danger "Fin du script `gen_hebdo.py` ❌ → 3 problèmes à résoudre :thinking: ..."        

<div style='text-align: right; color: gray; font-size: 16px; line-height: 0;'>📋 <span style='font-style: italic;'>Dernier rapport généré le 08/09/2025 à 05:04</span>.</div>
