    ...
    env.lang.overload(
        {
            ...
            "comments": Tip(
                17,
                "(Dés-)Active le code après la ligne <code>{tests}</code> "
                "(insensible à la casse)",
                "Ctrl+I",
            ),
            "split_screen": Tip(
                23,
                'Entrer ou sortir du mode "deux colonnes"<br>(<kbd>Alt+:</kbd> '
            ...
            "feedback": Tip(
                19,
                "Tronquer ou non le feedback dans les terminaux (sortie standard"
                " & stacktrace / relancer le code pour appliquer)",
            ),
            "wrap_term": Tip(
                19,
                "Si activé, le texte copié dans le terminal est joint sur une "
                "seule ligne avant d'être copié dans le presse-papier",
            ),
            # Runtime feedback
            "run_script": Msg("Script lancé...", format="info"),
            "install_start": Msg(
                "Installation de paquets python. Ceci peut prendre un certain temps...",
                format="info",
            ),
            "install_done": Msg("Installations terminées !", format="info"),
            "refresh": Msg(
                "Une version plus récente du code existe.\nVeuillez copier vos "
                "éventuelles modifications puis réinitialiser l'IDE.",
                format="warning",
            ),
            ...
            "unforgettable": Msg(
                "N'oubliez pas de faire une validation !", format="warning"
            ),
            ...
            "fail_tail": MsgPlural(
                "est maintenant disponible", "sont maintenant disponibles"
            ),
            ...
            "check": Tip(
                9,
                "Valider<br><kbd>Ctrl</kbd>+<kbd>Enter</kbd><br>(Clic droit pour l'historique)",
            ),
            ...
            "restart_confirm": Tip(
                0,
                "ATTENTION: réinitialiser l'éditeur fera perdre les anciens codes, status de validation et historiques.",
            ),
            ...
            # Others
            "tip_trash": Tip(
                15, "Supprimer du navigateur les codes enregistrés pour {site_name}"
            ),
            ...
            "zip_ask_for_names": Msg(
                "Veuillez préciser votre/vos noms (chaîne vide interdite) :"
            ),
        }
    )
